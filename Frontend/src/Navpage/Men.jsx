...
const Men = () => {
  ...
  const randomProducts = shuffleProducts(menProducts);
    ...
    <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section className="rounded-3xl bg-slate-900 px-6 py-14 text-white sm:px-10">
        ...
        <p className="mt-4 max-w-xl text-gray-300">
          Discover stylish and comfortable clothing made for your everyday look.
        </p>
      ...
      <section className="mt-12">
        ...
        <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
          ...
          {categories.map((e) => (
            <Link
              key={e.name}
              to={`/products?gender=Men&category=${e.name}`}
